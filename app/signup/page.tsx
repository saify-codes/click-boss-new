...
const SignUp: React.FC = () => {
  ...
  const createAccount: SubmitHandler<FieldValues> = async (data, event) => {
              ...
              <form onSubmit={handleSubmit(createAccount)}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    {errors.name?.type === 'minLength' && <small className='text-danger'>min 3 characters required</small>}
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    {errors.email?.type === 'exists' && (<small className='text-danger'>{errors.email?.message?.toString()}</small>)}
